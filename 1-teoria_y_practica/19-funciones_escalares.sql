...
-- El siguiente ejemplo ilustra cómo utilizar la función sales.udfNetSale para obtener las ventas netas de los 
...
/* Modificación de una función escalar
   ...
   Por ejemplo, para eliminar la función sales.udfNetSale, utilice la siguiente sentencia:        */
...
- Las funciones escalares no pueden actualizar datos. Pueden acceder a los datos, pero no es una buena práctica.
