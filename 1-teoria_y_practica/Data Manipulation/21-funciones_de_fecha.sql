...
-- Devuelve la fecha y hora actual del sistema
-- Es lo mismo que GETDATE()
SELECT CURRENT_TIMESTAMP AS fecha_actual -- 2023-01-23 17:18:42.813
...
-- Devuelve la fecha y hora actual del sistema. Los milisegundos se muestran de forma más detallada
SELECT SYSDATETIME() AS fecha_actual -- 2023-01-23 17:23:30.5968096
...
-- ==========================================
-- === DATEFROMPARTS y DATETIME2FROMPARTS ===
-- ==========================================

SELECT DATEFROMPARTS(2015, 06, 24) AS fecha
...
SELECT DATETIME2FROMPARTS(2015, 06, 24, 12, 34, 56, 124, 5) AS fecha

-- |-------------------------|
-- |          fecha          |
-- |-------------------------|
-- |2015-06-24 12:34:56.00124|   
-- |-------------------------|